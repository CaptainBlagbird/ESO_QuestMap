...
local strings = {
	...
	QUESTMAP_MENU_PIN_SIZE_TT     = "Defines the display size of the map pins (default: 25)",
	
	QUESTMAP_MENU_PIN_LVL         = "Map pin level",
	QUESTMAP_MENU_PIN_LVL_TT      = "Defines on which level the map pins are drawn (default: 40)",

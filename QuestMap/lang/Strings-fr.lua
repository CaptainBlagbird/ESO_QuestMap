...
SafeAddString( QUESTMAP_MENU_NOTE_1,           "Note: 'Réinitialiser' ne réinitialise PAS les marqueurs de quêtes cachés manuellement.", 1)
SafeAddString( QUESTMAP_MENU_NOTE_2,           "Si vous voulez effacer simultanément TOUT les marqueurs de quêtes manuellement cachés, vous pouvez utiliser ce bouton:", 1)
